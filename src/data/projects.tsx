...
const projects: Project[] = [
  ...
  { // 03. Portfolio project
    ...
    category: "portolio",
    title: "Portfolio",
    src: "/assets/projects-screenshots/myportfolio/landing-page.png",
    screenshots: ["/assets/projects-screenshots/myportfolio/landing-page.png"],
    live: "https://www.ahmadfauzan.com/",
    skills: {
      frontend: [
        PROJECT_SKILLS.ts,
        PROJECT_SKILLS.next,
    ...
    get content() {
      return (
        <div>
          ...
          <SlideShow
            images={[
              `${BASE_PATH}/myportfolio/landingpage.png`,
              `${BASE_PATH}/portfolio/skills.png`,
            ]}
          />
          <TypographyH3 className="my-4 ">Space Theme</TypographyH3>
