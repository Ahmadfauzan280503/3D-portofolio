...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "ahmadfauzan280503@gmail.com",
    href: "mailto:ahmadfauzan280503@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "Phone",
    content: "+6282177561275",
    href: "whatsapp:+6282177561275",
    icon: <FaPhone height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/ahmad-fauzan-f28a05u03/",
    content: "/ahmad-fauzan",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Ahmadfauzan280503",
    content: "/ahmadfauzan280503",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Ahmad Fauzan</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Ahmad Fauzan, a Comp. Sci. Engineer with 1.5 year experience in Devlopment, DevOps and 
